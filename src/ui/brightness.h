...
#define BRIGHTNESS_CIRCLE_INCREMENT ((BRIGHTNESS_LINE_X_END - BRIGHTNESS_LINE_X_START) / (float)MIN_BRIGHTNESS)
#define BRIGHTNESS_CIRCLE_X (BRIGHTNESS_LINE_X_END - Var_GetBright() * BRIGHTNESS_CIRCLE_INCREMENT)
//Drawing arrows
