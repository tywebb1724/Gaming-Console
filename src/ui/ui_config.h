...
#define LAUNCH_RIGHT_FACE_DOWN_TXT_X (LAUNCH_RIGHT_FACE_DOWN_X)
#define LAUNCH_RIGHT_FACE_DOWN_TXT_Y (LAUNCH_RIGHT_FACE_DOWN_Y)
...
#define LAUNCH_RIGHT_FACE_RIGHT_TXT_X (LAUNCH_RIGHT_FACE_RIGHT_X)
#define LAUNCH_RIGHT_FACE_RIGHT_TXT_Y (LAUNCH_RIGHT_FACE_RIGHT_Y)
#define LAUNCH_RIGHT_FACE_UP_X (Var_GetMonitorWidth() / 1600 * 731)
#define LAUNCH_RIGHT_FACE_UP_Y (Var_GetMonitorHeight() / 800 * 421)
#define LAUNCH_RIGHT_FACE_UP_TXT_X (LAUNCH_RIGHT_FACE_UP_X)
#define LAUNCH_RIGHT_FACE_UP_TXT_Y (LAUNCH_RIGHT_FACE_UP_Y)
#define LAUNCH_RIGHT_FACE_LEFT_X (Var_GetMonitorWidth() / 1600 * 691)
#define LAUNCH_RIGHT_FACE_LEFT_Y (Var_GetMonitorHeight() / 800 * 456)
#define LAUNCH_RIGHT_FACE_LEFT_TXT_X (LAUNCH_RIGHT_FACE_LEFT_X)
#define LAUNCH_RIGHT_FACE_LEFT_TXT_Y (LAUNCH_RIGHT_FACE_LEFT_Y)
//Middle buttons
...
#define LAUNCH_HOME_TXT_X (LAUNCH_HOME_RECT_X + LAUNCH_HOME_RECT_W / 2)
#define LAUNCH_HOME_TXT_Y (LAUNCH_HOME_RECT_Y + LAUNCH_HOME_RECT_H / 2)
...
#define LAUNCH_BACK_TXT_X (LAUNCH_BACK_RECT_X + LAUNCH_BACK_RECT_W / 2)
#define LAUNCH_BACK_TXT_Y (LAUNCH_BACK_RECT_Y + LAUNCH_BACK_RECT_H / 2)
...
#define LAUNCH_START_TXT_X (LAUNCH_START_RECT_X + LAUNCH_START_RECT_W / 2)
#define LAUNCH_START_TXT_Y (LAUNCH_START_RECT_Y + LAUNCH_START_RECT_H / 2)
//D-Pad
...
#define LAUNCH_DPAD_TXT_X (LAUNCH_DPAD_RECT_X + LAUNCH_DPAD_RECT_W / 2)
#define LAUNCH_DPAD_TXT_Y (LAUNCH_DPAD_RECT_Y + LAUNCH_DPAD_RECT_H / 2)
//Joysticks
...
#define LAUNCH_RS_TXT_X (LAUNCH_RS_RECT_X + LAUNCH_RS_RECT_W / 2)
#define LAUNCH_RS_TXT_Y (LAUNCH_RS_RECT_Y + LAUNCH_RS_RECT_H / 2)
...
#define LAUNCH_LS_TXT_X (LAUNCH_LS_RECT_X + LAUNCH_LS_RECT_W / 2)
#define LAUNCH_LS_TXT_Y (LAUNCH_LS_RECT_Y + LAUNCH_LS_RECT_H / 2)
//Triggers
...
#define LAUNCH_LT_TXT_X (LAUNCH_LT_RECT_X + LAUNCH_LT_RECT_W / 2)
#define LAUNCH_LT_TXT_Y (LAUNCH_LT_RECT_Y + LAUNCH_LT_RECT_H / 2)
...
#define LAUNCH_RT_TXT_X (LAUNCH_RT_RECT_X + LAUNCH_RT_RECT_W / 2)
#define LAUNCH_RT_TXT_Y (LAUNCH_RT_RECT_Y + LAUNCH_RT_RECT_H / 2)
//Bumpers
...
#define LAUNCH_LB_TXT_X (LAUNCH_LB_RECT_X + LAUNCH_LB_RECT_W / 2)
#define LAUNCH_LB_TXT_Y (LAUNCH_LB_RECT_Y + LAUNCH_LB_RECT_H / 2)
...
#define LAUNCH_RB_TXT_X (LAUNCH_RB_RECT_X + LAUNCH_RB_RECT_W / 2)
#define LAUNCH_RB_TXT_Y (LAUNCH_RB_RECT_Y + LAUNCH_RB_RECT_H / 2)
//Keyboard and mouse
...
#define LAUNCH_KEY_TAB_TXT_X (LAUNCH_KEY_TAB_LINE_X)
#define LAUNCH_KEY_TAB_TXT_Y (LAUNCH_KEY_TAB_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_Q_TXT_X (LAUNCH_KEY_Q_LINE_X)
#define LAUNCH_KEY_Q_TXT_Y (LAUNCH_KEY_Q_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_W_TXT_X (LAUNCH_KEY_W_LINE_X)
#define LAUNCH_KEY_W_TXT_Y (LAUNCH_KEY_W_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_E_TXT_X (LAUNCH_KEY_E_LINE_X)
#define LAUNCH_KEY_E_TXT_Y (LAUNCH_KEY_E_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_U_TXT_X (LAUNCH_KEY_U_LINE_X)
#define LAUNCH_KEY_U_TXT_Y (LAUNCH_KEY_U_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_I_TXT_X (LAUNCH_KEY_I_LINE_X)
#define LAUNCH_KEY_I_TXT_Y (LAUNCH_KEY_I_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_O_TXT_X (LAUNCH_KEY_O_LINE_X)
#define LAUNCH_KEY_O_TXT_Y (LAUNCH_KEY_O_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_P_TXT_X (LAUNCH_KEY_P_LINE_X)
#define LAUNCH_KEY_P_TXT_Y (LAUNCH_KEY_P_Y + LAUNCH_KEY_REC_H / 2.0f)
//2nd keyboard line
...
#define LAUNCH_KEY_A_TXT_X (LAUNCH_KEY_A_LINE_X)
#define LAUNCH_KEY_A_TXT_Y (LAUNCH_KEY_A_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_S_TXT_X (LAUNCH_KEY_S_LINE_X)
#define LAUNCH_KEY_S_TXT_Y (LAUNCH_KEY_S_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_D_TXT_X (LAUNCH_KEY_D_LINE_X)
#define LAUNCH_KEY_D_TXT_Y (LAUNCH_KEY_D_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_F_TXT_X (LAUNCH_KEY_F_LINE_X)
#define LAUNCH_KEY_F_TXT_Y (LAUNCH_KEY_F_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_H_TXT_X (LAUNCH_KEY_H_LINE_X)
#define LAUNCH_KEY_H_TXT_Y (LAUNCH_KEY_H_Y + LAUNCH_KEY_REC_H / 2.0f )
...
#define LAUNCH_KEY_J_TXT_X (LAUNCH_KEY_J_LINE_X)
#define LAUNCH_KEY_J_TXT_Y (LAUNCH_KEY_J_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_K_TXT_X (LAUNCH_KEY_K_LINE_X)
#define LAUNCH_KEY_K_TXT_Y (LAUNCH_KEY_K_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_L_TXT_X (LAUNCH_KEY_L_LINE_X)
#define LAUNCH_KEY_L_TXT_Y (LAUNCH_KEY_L_Y + LAUNCH_KEY_REC_H / 2.0f)
//Other keys
...
#define LAUNCH_KEY_ENTER_TXT_X (LAUNCH_KEY_ENTER_LINE_X)
#define LAUNCH_KEY_ENTER_TXT_Y (LAUNCH_KEY_ENTER_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_RSHIFT_TXT_X (LAUNCH_KEY_RSHIFT_LINE_X)
#define LAUNCH_KEY_RSHIFT_TXT_Y (LAUNCH_KEY_RSHIFT_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_LSHIFT_TXT_X (LAUNCH_KEY_LSHIFT_LINE_X )
#define LAUNCH_KEY_LSHIFT_TXT_Y (LAUNCH_KEY_LSHIFT_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_SPACE_TXT_X (LAUNCH_KEY_SPACE_LINE_X)
#define LAUNCH_KEY_SPACE_TXT_Y (LAUNCH_KEY_SPACE_Y + LAUNCH_KEY_REC_H / 2.0f)
//Mouse
...
#define LAUNCH_KEY_MOUSE_TXT_X (LAUNCH_KEY_MOUSE_LINE_X)
#define LAUNCH_KEY_MOUSE_TXT_Y (LAUNCH_KEY_MOUSE_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_LCLICK_TXT_X (LAUNCH_KEY_LCLICK_LINE_X)
#define LAUNCH_KEY_LCLICK_TXT_Y (LAUNCH_KEY_LCLICK_Y + LAUNCH_KEY_REC_H / 2.0f)
...
#define LAUNCH_KEY_RCLICK_TXT_X (LAUNCH_KEY_RCLICK_LINE_X)
...
#define LAUNCH_KEY_ARROWS_TXT_X (LAUNCH_KEY_ARROWS_REC_X + LAUNCH_KEY_REC_W / 2.0f)
#define LAUNCH_KEY_ARROWS_TXT_Y (LAUNCH_KEY_ARROWS_LINE_Y)
//String lengths
#define LAUNCH_STR_LEN 15
#pragma endregion

//Macros for alphas
#pragma region UI_ALPHA
