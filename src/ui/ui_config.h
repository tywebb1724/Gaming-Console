...
//D-Pad
#define LAUNCH_D_RECT_W (Var_GetMonitorWidth() / 21.0f)
#define LAUNCH_D_RECT_H (Var_GetMonitorHeight() / 30.0f)
#define LAUNCH_D_RECT_X (Var_GetMonitorWidth() / 800.0f * 154)
#define LAUNCH_D_RECT_Y (Var_GetMonitorHeight() / 400.0f * 328)
...
//Keys
#define LAUNCH_KEY_W (Var_GetMonitorHeight() / 10.0f)
#define LAUNCH_KEY_H (Var_GetMonitorHeight() / 25.0f)
#define LAUNCH_KEY_ROW1COL1_X1 (Var_GetMonitorWidth() / 800.0f * 410)
#define LAUNCH_KEY_ROW1COL1_X2 (LAUNCH_KEY_ROW1COL1_X1 + LAUNCH_KEY_W / 2.0f)
#define LAUNCH_KEY_ROW1COL1_X3 (LAUNCH_KEY_ROW1COL1_X1 + LAUNCH_KEY_W)

#define LAUNCH_KEY_ROW1COL2_X1 ()
#define LAUNCH_KEY_ROW1COL2_X2 ()
#define LAUNCH_KEY_ROW1COL1_X1_TXT (LAUNCH_KEY_ROW1COL1_X1 + LAUNCH_KEY_W / 4.0f - row1col1_1Size.x / 2)
#define LAUNCH_KEY_ROW1COL1_X2_TXT (LAUNCH_KEY_ROW1COL1_X2 + LAUNCH_KEY_W / 4.0f - row1col1_2Size.x / 2)

#define LAUNCH_KEY_ROW1COL2_X1 ()
#define LAUNCH_KEY_ROW1COL2_X2 ()
#define LAUNCH_KEY_ROW1COL2_X1_TXT ()
#define LAUNCH_KEY_ROW1COL2_X2_TXT ()


#define LAUNCH_KEY_ROW1COL1_Y1 (Var_GetMonitorHeight() / 400.0f * 140)
#define LAUNCH_KEY_ROW2COL1_Y1 (LAUNCH_KEY_ROW1COL1_Y1 + LAUNCH_KEY_H * 2)
#define LAUNCH_KEY_ROW1COL1_Y1_TXT (LAUNCH_KEY_ROW1COL1_Y1 - row1col1_1Size.y / 2)
#define LAUNCH_KEY_ROW1COL1_Y2_TXT (LAUNCH_KEY_ROW1COL1_Y1 - row1col1_2Size.y / 2)
#pragma endregion
