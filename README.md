...
5. Place cover images (`.png`) in `assets/images/<console>/`
 **Note:** *Image files must match the ROM filename exactly (e.g SuperMario.png for SuperMario.nes).*

6. Launch the app using the desktop icon, or run it directly:
```bash
./SP1DER-GAMES
```
